package com.example.sqlitleapp.model

import android.content.ContentValues
import android.content.Context
import android.database.Cursor
import android.database.sqlite.SQLiteDatabase
import com.example.sqlitleapp.db.HelperDB
...
class Categoria (context: Context?) {
    ...
    fun insertValuesDefault () {
        ...
        // Validando que se ingrese la informacion solamente una vez, cuando se instala por primera vez,
        // cuando se instala por primera vez la aplicacion
    ...
    // Debido a que el Spinner solalemte guarda el nombre, esta funcion nos ayudara a recuperar el ID
    // de la categoria.
