package com.example.retrofitaoo
...
import com.example.retrofitaoo.databinding.ActivityMainBinding
import com.example.retrofitaoo.dto.DogAdapter
import com.example.retrofitaoo.model.DogsResponse
import com.example.retrofitaoo.services.ApiService
...
class MainActivity : AppCompatActivity() {
    ...
    private fun initSpinner() {
        binding!!.searchDogs.onItemSelectedListener = object :
            AdapterView.OnItemSelectedListener {
            override fun onItemSelected(parent: AdapterView<*>?, view: View?, position: Int, id: Long) {
                val selectedBreed = parent?.getItemAtPosition(position).toString()
                searchByName(selectedBreed.lowercase(Locale.getDefault()))
            }
